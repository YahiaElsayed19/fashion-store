...
const Hero = () => {
    return (
        <section className="flex flex-col py-[120px] bg-gray-50 dark:bg-dark-container bg-image relative">
            ...
            <div className="container max-w-5xl gap-4 px-[15px] mx-auto z-30">
                <div className="flex flex-col gap-3 items-center sm:items-start text-center sm:text-left text-white p-5 mx-auto">
                    ...
                    <h1 className="text-primary text-3xl sm:text-5xl max-w-md font-extrabold mb-4">Experience fashion like never before.</h1>
                    <button
                        type="button"
                        className="button "
                    >
