...
const ProductsList = ({
    ...
    return (
        <div className="flex flex-col items-center bg-white dark:bg-black group list">
            <h1 className="text-2xl font-bold uppercase text-center text-black dark:text-white">
                <span className="text-primary">{title}</span> products
            </h1>
            <div className="container w-full max-w-6xl p-5 mx-auto ">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5 p-5 rounded-xl bg-gray-200 dark:bg-dark-container">
                    {products.length > 0 &&
